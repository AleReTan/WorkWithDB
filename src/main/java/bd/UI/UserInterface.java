...
public class UserInterface extends JFrame {
    ...
    public UserInterface() throws Exception {
        ...
        service.openDB();
        //добить это в метод обновить бд, либо по другому как нибудь
        ...
        DBTableModel dbTableModel2 = new DBTableModel(true);//модель для таблицы
        ...
        DBTableModel dbTableModel3 = new DBTableModel(true);//модель для таблицы
        ...
        DBTableModel dbTableModel4 = new DBTableModel(true);//модель для таблицы
            ...
            try {
                ...
                switch (string) {
                    case "Add": {
                        ...
                        String newText = textField1.getText().toString();
...
//                        service.resultSet = service.preparedStatement.executeQuery("delete from books where idBooks = 3");
//                        service.preparedStatement.executeUpdate();
                        break;
                    }
                    case "Delete": {
